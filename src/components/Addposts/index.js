    ...
    const handleUpload = (event) => {
        ...
        if (caption == "" && imageURL == "") {
            ...
            if (imageURL == '') {
                ...
                setImage("https://i0.wp.com/gadgets-africa.com/wp-content/uploads/2020/04/UniversityOfNairobiTowersProject_banner.jpg");
            } else {
  ...
  <FormInput
            ...
            />
                    ...
                    <div class={`card-img-top navbar-brand previewImage ${!image && "vanish"}`}>
                        <img class="card-img-top navbar-brand previewImaage" src={imageURL} className="" />
                    </div>
                    <div class="right">
            <div className="">
                        <div class="">
                    ...
                    <Button style={{cursor: "pointer"}} value={caption} onClick={handleClickOpen('body')} placeholder={`Click here to post a product`} variant="contained" color="primary">Add </Button>
